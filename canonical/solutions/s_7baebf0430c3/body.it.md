# Dati
Livello: $\qty{0}{\dBm}$, $\qty{3}{\dBm}$, $\qty{20}{\dBm}$

# Procedimento
Utilizziamo la formula del $\unit{\dBm}$ dalla raccolta di formule (livelli, livelli di potenza e di tensione):
...
# Abbreviazione
Chi ha familiarità con i logaritmi e la tabella degli strumenti può giungere rapidamente alla soluzione corretta per esclusione.
$\qty{0}{\dBm} \rightarrow \qty{1}{\milli\watt}$ (rimangono solo due risposte possibili).
