...
Dallo schema del circuito risulta inoltre:

$ U_D = \qty{4}{\volt} $

Ai capi della resistenza $R_\text{BIAS}$ si ha quindi la differenza di tensione:

$ U_{\text{BIAS}} = U_\mathrm{CC} - U_D = \qty{9}{\volt} - \qty{4}{\volt} = \qty{5}{\volt} $

Da ciò si ricava la corrente che attraversa $R_\text{BIAS}$ e il MMIC:

$ I_D = \frac{U_{\text{BIAS}}}{R_\text{BIAS}} = \frac{\qty{5}{\volt}}{\qty{470}{\ohm}} \approx \qty{10,6}{\milli\ampere} $

La potenza termica dissipata nel MMIC è:

$ P_D = U_D \cdot I_D = \qty{4}{\volt} \cdot \qty{10,6}{\milli\ampere} \approx \qty{42,6}{\milli\watt} $

Arrotondando, si ottiene:
