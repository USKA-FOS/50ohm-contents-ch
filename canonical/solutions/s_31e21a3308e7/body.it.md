...
Dallo schema si evince inoltre:

$ U_D = \qty{4}{\volt} $

Sul resistore $R_\text{BIAS}$ cade quindi la differenza di tensione:

$ U_\text{BIAS} = U_\mathrm{CC} - U_D = \qty{9}{\volt} - \qty{4}{\volt} = \qty{5}{\volt} $

Ciò determina la corrente attraverso $R_\text{BIAS}$ e il MMIC:
