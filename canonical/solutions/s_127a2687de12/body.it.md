...
In una [collegamento in serie](#), le tensioni si sommano:

$ U = 30 \cdot \qty{0,6}{\volt} = \qty{18}{\volt} $


La corrente di cortocircuito rimane inizialmente invariata in una serie:

$ I_\mathrm{SC} = \qty{1}{\ampere} $


Poiché quattro di queste serie sono collegate in parallelo, le correnti si sommano:
