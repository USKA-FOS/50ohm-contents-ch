Si cerca la potenza dissipata dalla resistenza $R_2$.
...
Per il collegamento in parallelo di $R_2$ e $R_3$ si ottiene:


$ R_{23} = \qty{5}{\kilo\ohm} $


Pertanto, la resistenza totale è:
...
Questa corrente si suddivide equamente tra $R_2$ e $R_3$:


$ I_{2} = \frac{I_\mathrm{ges}}{2} = \qty{0,5}{\milli\ampere} $


La potenza dissipata dalla resistenza $R_2$ si calcola con:
