...
<right>
* Tensione $\qty{10}{\volt}$
* Corrente $\qty{1}{\milli\ampere}$
</right>

---

* A $\qty{20}{\volt}$ la corrente aumenta a $\qty{2}{\milli\ampere}$
* A $\qty{5}{\volt}$ la corrente diminuisce a $\qty{0,5}{\milli\ampere}$
...
La resistenza è il *rapporto tra tensione e corrente*
...
## Riorganizzazione delle formule

<left>
* Tensione e resistenza note
* Corrente sconosciuta

$ I = \dfrac{U}{R} $
</left>
<right>
* Corrente e resistenza note
* Tensione sconosciuta
