* Stabilisation d'un oscillateur variable, potentiellement instable (par exemple, VCO) au moyen d'un oscillateur de référence stable
* Comparaison de phase entre les deux signaux
* La fréquence de sortie correspond à la fréquence de référence ou à un multiple de celle-ci et reste stable
...
* Le *filtre passe-bas* transforme les impulsions du comparateur de phase en tension continue
...
<note>
Le comparateur de phase émet des impulsions en cas de déphasage, qui sont lissées en une tension continue par le filtre passe-bas. Le changement de fréquence sur le VCO réduit progressivement la différence de phase.
</note>
...
* Le diviseur de fréquence permet le réglage de la PLL sur différentes fréquences
* La fréquence de sortie est un multiple entier de la fréquence de référence
* La plus petite fréquence sélectionnable correspond à l'oscillateur de référence
