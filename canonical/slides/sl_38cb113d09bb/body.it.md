...
* Indicazione logaritmica di rapporti, in particolare di potenze
* Rende più facile lavorare con potenze piccole e grandi
...
<fragment>
$\rightarrow\qty{0}{\dBm}$ si ha con $P = \qty{1}{\milli\watt}$
</fragment>
...
<fragment>
$\rightarrow\qty{0}{\dBW}$ si ha con $P = \qty{1}{\watt}$
</fragment>
...
$\rightarrow\qty{0}{\dBu}$ si ha con $U = \qty{0,775}{\volt}$
</fragment>
<fragment>
*Tensione riferita a $\qty{1}{\volt}$*
$\rightarrow\qty{0}{\dBV}$ si ha con $U = \qty{1}{\volt}$
</fragment>
<fragment>
*Tensione riferita a $\qty{1}{\micro\volt}$*
$\rightarrow\qty{0}{\dBuV}$ si ha con $U = \qty{1}{\micro\volt}$
</fragment>

<note>
Dettagli sul calcolo del fattore 20 nel corso online. Breve riassunto: Nel rapporto di tensione si calcola con i quadrati, che possono essere portati come fattore davanti al logaritmo.
</note>
---
[question:AA111]
---
...
<fragment>
Nella letteratura si trova spesso: $\qty{120}{\dBuV} = \qty{1}{\volt}$
</fragment>
