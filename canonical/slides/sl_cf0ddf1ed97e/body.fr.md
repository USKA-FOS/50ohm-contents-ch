...
<right>
Définition: La largeur d'impulsion est à 50% de la valeur de crête
</right>
---
[question:AI303]
---
...
<left>
[photo:219:a_oszilloskop_x-ablenkung:Sans tension d'entrée, un point se déplace simplement de gauche à droite sur l'écran d'un oscilloscope analogique, ici à une vitesse d'un division par seconde.]
</left>
<right>
* Le déclenchement évalue le signal appliqué
* Par exemple, la tension 0 passant de négatif à positif
* Cela permet d'afficher une image fixe pour une onde
</right>
---
[question:AI302]
---
...
<left>
[photo:223:a_ozilloskop_tastkoepfe:Sondes avec différentes pointes de test. Les pinces crocodile ont été retirées pour cette prise de vue.]
</left>
<right>
* Pour mesurer la tension
* Pointe construite en forme de crochet ou d'aiguille
* Masse de référence généralement via une pince crocodile séparée
* Les sondes 10:1 divisent la tension par dix
</right>
---
...
### Solution
* donné: $R=50\Omega$
* donné: (à partir de la représentation) $\hat{U} = 100V$
...
### Solution
* donné: $R=\qty{50}{\ohm}$
* donné: (à partir de la représentation avec une sonde 10:1) $\hat{U} = \qty{6}{\volt}\cdot 10$
* recherché: $P_{\textrm{PEP}}$
...
<left>
* Un signal passe d'une valeur à une valeur plus élevée et revient à un moment ultérieur
* La durée de l'impulsion est mesurée du milieu du front montant au milieu du front descendant
</left>
<right>
[picture:57:e_impuls:Impulsion dans un oscilloscope] 
</right>
---
[question:EI303]