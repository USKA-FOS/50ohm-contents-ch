## Antennes d'excitation dans un réflecteur parabolique
<left>
[picture:850:a_parabolspiegel_schnitt:Coupe d'un réflecteur parabolique avec antenne]
</left>
<right>
* Les antennes d'excitation sont placées au point focal devant le réflecteur parabolique
* Les antennes hélicoïdales, qui génèrent une polarisation circulaire, sont particulièrement adaptées pour la gamme des micro-ondes
</right>

---
## Antennes cornet et guides d'ondes
<left>
Image d'une antenne cornet à suivre
</left>
<right>
* Les antennes cornet peuvent être alimentées par un guide d'onde
* Dans les guides d'ondes, c'est-à-dire des tubes métalliques, l'énergie des micro-ondes est guidée par réflexion sur les parois extérieures
</right>

---
## Les guides d'ondes en détail

* Les guides d'ondes guident les micro-ondes en les réfléchissant sur leurs parois métalliques extérieures
* Ainsi, l'onde parvient dans un cornet, d'où elle est rayonnée ou injectée dans le guide d'onde

---
[question:AG225]
---
## Gain d'un réflecteur parabolique

$g_i = 10 \cdot \log_{10}{\left(\left(\frac{\pi \cdot d}{\lambda}\right)^2 \cdot \eta\right)}\unit{\dBi}$

* Calcul à l'aide de la formule dans le recueil de formules
* Dépend du diamètre
* Gain généralement très élevé
...
<left>
* donné : $d = \qty{30}{\centi\meter}$
* donné : $\eta_{eff} = 1$
</left>
<right>
* donné : $f = \qty{5,7}{\giga\hertz}$
* recherché : $g_i$
</right>
