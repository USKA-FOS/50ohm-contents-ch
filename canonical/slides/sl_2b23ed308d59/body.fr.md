## Règle des mailles et des nœuds

*Règle des mailles* : Dans chaque circuit électrique fermé (maille), la somme des tensions est égale à zéro.
*Règle des nœuds* : Dans chaque nœud, la somme des courants entrants est égale à la somme des courants sortants.
...
---
#### Solution
* donné : $R_1 = R_2 = R_3 = \qty{10}{\kilo\ohm}$
* donné : $I_3 = I_2 = \qty{1}{\milli\ampere}$
* recherché : $U$
...
<left>
* donné : $R = \qtyrange{0}{1}{\kilo\ohm}$
* donné : $R_1 = \qty{200}{\ohm}$
* donné : $R_2 = \qty{100}{\ohm}$
* donné : $R_3 = \qty{200}{\ohm}$
</left>
...
---
#### Solution
* donné : $R_1 = R_3 = \qty{2,2}{\kilo\ohm}$
* donné : $R_2 = R_4 = \qty{220}{\ohm}$
* recherché : $R_{\mathrm{ges}}$
...
* donné : $R_2 = \qty{2,2}{\kilo\ohm}$
* donné : $R_L = \qty{8,2}{\kilo\ohm}$
* donné : $U_B = \qty{12}{\volt}$
* recherché : $U_2$
