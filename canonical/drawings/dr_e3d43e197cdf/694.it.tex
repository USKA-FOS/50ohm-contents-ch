...
\begin{circuitikz}
    ...
    %
    \draw(0,-1-|battery.center) node[](){batteria};
    \draw(0,-1-|resistor.center) node[](){Resistenza};
    \draw(0,-1-|capacitor.center) node[](){condensatore};
    \draw(0,-1-|inductor.center) node[](){bobina};
    %
    \draw(0,-3-|diode.center) node[](){Diode};
    \draw(0,-3-|led.center) node[](){LED};
    \draw(0,-3-|switch.center) node[](){interruttore};
    \draw(0,-3-|transistor1.center) node[](){Transistor};
    %
    \draw(0,-5-|antenna1.center) node[](){antenna};
    \draw(0,-5-|ground.center) node[align=center](){Massa e\\terra};
    \draw(0,-5-|vm.center) node[align=center](){Strumenti di\\misura della tensione};
    \draw(0,-5-|am.center) node[align=center](){Strumenti di\\misura della corrente};
\end{circuitikz} 