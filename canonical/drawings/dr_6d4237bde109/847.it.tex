...
\begin{tikzpicture}[rotate=90]
    ...
    % Begriffe
    \draw( 1.00,-0.75) node[fill=white,rotate=-90](){\small Radiazione ad alta quota};
    \draw( 2.50,-1.25) node[fill=white,rotate=-90](){\small Radiazione gamma};
    \draw( 5.00,-0.75) node[fill=white,rotate=-90](){\small Raggi X};
    \draw( 7.50,-1.50) node[fill=white,rotate=-90](){\small Ultravioletti};
    \draw( 8.60,-1.00) node[fill=white,rotate=-90](){\small Luce};
    \draw( 9.75,-0.50) node[fill=white,rotate=-90](){\small Infrarosso};
    \draw(11.00,-1.00) node[fill=white,rotate=-90](){\small Radiazione terahertz};
    \draw(12.50,-0.50) node[fill=white,rotate=-90](){\small Radar};
    \draw(13.25,-1.50) node[fill=white,rotate=-90](){\small Radiazione a microonde};
    \draw(16.50,-1.00) node[fill=white,rotate=-90](){\small Onde radio};
    \draw(20.50,-1.00) node[fill=white,rotate=-90](){\small Correnti alternate};
