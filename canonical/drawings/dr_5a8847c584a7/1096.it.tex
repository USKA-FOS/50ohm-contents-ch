...
\begin{axis}[
    ...
    ymin=-90,
    ymax=38,
    xlabel={potenza d’ingresso $P_\text{in}$},
    ylabel={potenza d’uscita $P_\text{out}$},
...
\addlegendentry{saturazione}

% ------------------------------------------------------------
% Reales Gresignal mit Kompression e saturazione
% ------------------------------------------------------------
\addplot[
    DARCblue,
    very thick,
...
\addlegendentry{$f_1$ e $f_2$}


% ------------------------------------------------------------
% Ideale Gresignal-Gerade, extrapoliert
% ------------------------------------------------------------
\addplot[
    DARCblue,
    very thick,
...
% ------------------------------------------------------------
% Reale IM3-Produkte mit Kompression e gleicher saturazione
% ------------------------------------------------------------
\addplot[
    DARCred,
    very thick,
