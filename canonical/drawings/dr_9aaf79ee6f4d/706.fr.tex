...
\tikzset{	% Laptop
  laptop/.pic ={
		\node (case) at (0, 0.04) [draw, minimum width=0.8cm, minimum height=0.5cm, rounded corners=0.5, anchor=center] {};				% Gehäuse
...
\begin{tikzpicture}	
	...
	\node[ipNetLabel] at (intern.center) {réseau\\interne};
	...
	\node (internet) [ipNetLabel] at (\xB, -0.5) {connexion\\Internet};
	...
	\node at (server) [ipNetLabel] {réseau de\\serveurs};
