...
\begin{circuitikz}
    ...
    \draw (c2) to [twoportsplit, l ={\footnotesize De-Mapper}] ++(1,0)
        to [twoportsplit, >,     l_={\footnotesize decodificatore di canale}] ++(3,0)
        to [twoportsplit, >,     l ={\footnotesize decodificatore di sorgente}] ++(1,0)
    ...
    \draw[gray] (11.5,1.5) node(){FPGA o Software};
\end{circuitikz}
