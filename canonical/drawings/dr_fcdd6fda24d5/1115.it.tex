...
\begin{axis}[
    ...
    ylabel={
        intensità del campo magnetico, normalizzata:
        $\lvert H\rvert/H_0$
    },
    tick label style={
        font=\normalsize
...
\begin{axis}[
    ...
    axis y line*=right,
    ylabel={
        intensità del campo elettrico, normalizzata:
