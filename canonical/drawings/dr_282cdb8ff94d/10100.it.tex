...
%     Öffnungswinkel nahe der Terra zur Folge, was für eine
...
%  4. "semiasse maggiore a": Pfeil hatte vorher Länge 2a und war
...
% ============================================================
% Terra (im besetzten Brennpunkt)
% ============================================================
\filldraw[fill=blue!55, draw=blue!20!black, thick]
    (Earth) circle (0.42cm);
\node[anchor=north] at (-\c,-0.6) {\textbf{Terra}};
...
\node[anchor=south west] at (3.92,2.70) {\textbf{più lento}};

\draw[very thick,->] (S2) -- ++(0.496,-0.061)
    node[above right=1pt] {\textbf{più veloce}};
