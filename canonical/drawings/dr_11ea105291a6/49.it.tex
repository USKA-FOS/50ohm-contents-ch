...
\draw(m1) node[anchor=north](){Materiale dielettrico/isolante};
\draw(2.6,0.5) -- ++(1,1.5) coordinate(m2) -- ++(1,-1.5);
\draw(m2) node[anchor=south](){Rivestimenti metallici};
\draw(1.5,-3.5) -- ++(1.5,-1) node[anchor=west](){Avvolgimento};
\end{tikzpicture}