...
% Beschriftungen:
\draw(ea)  node[rotate=90, align=center](hh1){\scriptsize Adattamento di\\\scriptsize ingresso};
\draw(aa)  node[rotate=90, align=center](hh3){\scriptsize Adattamento di\\\scriptsize uscita};
