...
\begin{circuitikz}[european]
    ...
    \draw (c0) ++(+0.50,0.50) node[right,rotate=-45](){couche D};
    \draw (c0) ++(+0.85,0.85) node[right,rotate=-45](){couche E};
    \draw (c0) ++(+1.42,1.42) node[right,rotate=-45](){couche $\text{F}_1+\text{F}_2$};
    %
    ...
    %
    \draw(sporadic.center) -- (0,1) node[below](){sporadique E};
\end{circuitikz}