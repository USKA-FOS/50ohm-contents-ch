...
\begin{tikzpicture}
    ...
    \draw(netzteil.north) ++(0,0.6) node[anchor=south]{Alimentatore};
    ...
    \draw[red](netzteil.plus)
        to [fuse, l={fusibile}, color=red] ++(2.5,0)
        to [short, i={corrente continua (I)}, color=red] (trx.plus);
    \draw(trx.minus) to [short, i={}, l={\textcolor{gray}{\small{\textit{\shortstack{Pericolo di cortocircuito\\e inversione di polarità}}}}}] (netzteil.minus);
    ...
    \draw[gray](c1) to [open] ++(-0.5,0.4) node[](c3){\itshape\small Alta tensione};
\end{tikzpicture}