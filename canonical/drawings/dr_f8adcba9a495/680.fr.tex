...
\begin{tikzpicture}
    ...
    \draw(netzteil.north) ++(0,0.6) node[anchor=south]{Bloc d'alimentation};
    ...
    \draw(trx.minus) to [short, i={}, l={\textcolor{gray}{\small{\textit{\shortstack{Risque de court-circuit\\et d'inversion de polarité}}}}}] (netzteil.minus);
