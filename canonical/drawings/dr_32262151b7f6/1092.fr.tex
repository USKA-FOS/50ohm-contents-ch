...
\begin{tikzpicture}
    ...
    \begin{axis}[
        name=plot1,
        title={1. Signal utile BF : tonalité unique},
        at={(0,0)}
    ]
        \addplot[DARCred]
            {sin(deg(2*pi*\fm*x))};
    ...
    \begin{axis}[
        name=plot2,
        title={2. AM de 1 : la tonalité unique module l’amplitude de la porteuse},
        at={(0,-2.8cm)}
    ]
    ...
    \begin{axis}[
        name=plot4,
        title={4. Signal utile BF à deux tonalités : p. ex. 700 Hz et 1200 Hz},
        at={(0,-8.4cm)}
    ]
        \addplot[DARCred]
    ...
    \begin{axis}[
        name=plot5,
        title={5. AM de 4 : les deux tonalités modulent l’amplitude de la porteuse},
        at={(0,-11.2cm)}
    ]
