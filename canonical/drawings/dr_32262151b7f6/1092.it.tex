...
\begin{tikzpicture}
    ...
    \begin{axis}[
        name=plot1,
        title={1. Segnale utile BF: tono singolo},
        at={(0,0)}
    ]
        \addplot[DARCred]
            {sin(deg(2*pi*\fm*x))};
    ...
    \begin{axis}[
        name=plot2,
        title={2. AM di 1: il tono singolo modula l’ampiezza della portante},
        at={(0,-2.8cm)}
    ]
    ...
    \begin{axis}[
        name=plot3,
        title={3. SSB di 1: una riga HF, inviluppo costante},
        at={(0,-5.6cm)}
    ]
    ...
    \begin{axis}[
        name=plot4,
        title={4. Segnale utile BF a due toni: ad es. 700 Hz e 1200 Hz},
        at={(0,-8.4cm)}
    ]
        \addplot[DARCred]
    ...
    \begin{axis}[
        name=plot5,
        title={5. AM di 4: i due toni modulano l’ampiezza della portante},
        at={(0,-11.2cm)}
    ]
    ...
    \begin{axis}[
        name=plot6,
        title={6. SSB di 4: due righe HF con battimento},
        at={(0,-14.0cm)}
    ]
