...
\begin{axis}[
    width=15cm,
    height=9cm,
    xlabel={altezza dell’orbita sopra la Terra $h$ [km]},
    ylabel={periodo orbitale $T$ [h]},
    xmin=0, xmax=50000,
    ymin=0, ymax=25,
    ...
    title={periodo orbitale di un satellite in funzione dell’altitudine orbitale},
...
\node[anchor=west, font=\small] at
(axis cs:36500,21.0)
{geostazionario: $h=35\,786$ km,\quad $T\approx23{,}93$ h};
