...
Selbst ohne genaue Rechnung wird schnell deutlich, dass die Kombination aus $\qty{6}{\watt}$ Sendeleistung und einem Antennengewinn von $\qty{13}{\dBd}$ (Faktor $\num{20}$) in der folgenden Frage den Grenzwert von $\qty{10}{\watt}$ EIRP deutlich überschreitet.

<indepth>
Zur Übung kann man das trotzdem rechnen: Wir nutzen erneut die Formel aus der Formelsammlung: 
...
Auch diese Rechnung lässt sich wieder leicht im Kopf durchführen, indem man den Gesamtgewinn in einzelne sinnvolle Anteile zerlegt:
