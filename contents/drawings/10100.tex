...
\filldraw[fill=blue!55, draw=blue!20!black, thick]
    (Earth) circle (0.42cm);
\node[anchor=north] at (-\c,-0.6) {\textbf{Erde}};
...
\node[below=3pt, align=center, text width=1.7cm, font=\tiny, gray!40!black]
    at (EmptyFocus) {zweiter Brennpunkt};
...
\node[anchor=south west] at (3.92,2.70) {\textbf{langsamer}};

\draw[very thick,->] (S2) -- ++(0.496,-0.061)
    node[above right=1pt] {\textbf{schneller}};
