...
% Position 1: weit von der Erde entfernt
\coordinate (S1) at (4.0,2.0);

% Position 2: näher bei der Erde
...
% Geschwindigkeitsvektor nahe Erde
\draw[very thick,->]
    (S2) -- ++(-1.1,0.25)
    node[below left] {\textbf{schneller}};

% Geschwindigkeitsvektor weit entfernt
\draw[very thick,->]
    (S1) -- ++(-0.45,0.35)
    node[above right] {\textbf{langsamer}};
