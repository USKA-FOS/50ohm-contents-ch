...
%     Öffnungswinkel nahe der Erde zur Folge, was für eine
...
%  4. "grosse Halbachse a": Pfeil hatte vorher Länge 2a und war
...
% ============================================================
% Erde (im besetzten Brennpunkt)
% ============================================================
\filldraw[fill=blue!55, draw=blue!20!black, thick]
    (Earth) circle (0.42cm);
\node[below left=4pt] at (Earth) {\textbf{Erde}};

% Leerer Brennpunkt (2. Brennpunkt der Ellipse, unbesetzt)
\draw[gray!70, thick] (EmptyFocus) circle (0.12cm);
\node[below right=2pt, font=\tiny, gray!40!black]
    at (EmptyFocus) {leerer Brennpunkt};
...
\draw[very thick,->] (S1) -- ++(-0.429,0.344)
    node[above left] {\textbf{langsamer}};

\draw[very thick,->] (S2) -- ++(0.496,-0.061)
    node[right] {\textbf{schneller}};
...
\draw[<->,thin] (0,-3.5) -- (\a,-3.5)
    node[midway,below] {grosse Halbachse $a$};

\node[align=center] at (-3.3,-3.9)
    {$A_1=A_2$\\
     (schematisch) gleiche Zeit};
...
{
\textbf{1. Keplersches Gesetz}\\
Der Satellit bewegt sich auf einer Ellipse.\\
Die Erde befindet sich in einem Brennpunkt.
};

\node[align=left, anchor=north west, text width=5.6cm] at (-5.2,-4.75)
{
\textbf{2. Keplersches Gesetz}\\
In gleichen Zeiten werden gleiche Flächen überstrichen.
};

\node[align=left, anchor=north west] at (1.6,-4.75)
{
\textbf{3. Keplersches Gesetz}\\
