...
\begin{axis}[
    width=15cm,
    height=9cm,
    xlabel={Höhe der Umlaufbahn über der Erde $h$ [km]},
    ylabel={Umlaufzeit $T$ [h]},
    xmin=0, xmax=50000,
    ymin=0, ymax=25,
    ...
    title={Umlaufzeit eines Satelliten in Abhängigkeit der Bahnhöhe},
...
\node[anchor=west, font=\small] at
(axis cs:36500,21.0)
{geostationär: $h=35\,786$ km,\quad $T\approx23{,}93$ h};
