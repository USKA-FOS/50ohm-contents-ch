...
Auch sind *rechtsgeschäftliche Mitteilung* explizit untersagt. Zwei Beispiele: 

Der Austausch von Preis-Informationen ist erlaubt ("Ich nutze ein Yaesu FT-991A. Kostet auf dem Gebrauchtmarkt aktuell ca. 700 Franken."). Das konkrete Anbieten, Verhandeln oder Abschliessen eines Verkaufs hingegen ist ein Rechtsgeschäft und damit verboten („Ich habe ein Yaesu FT-991A. Wer zuerst 700 Franken bietet, bekommt es. Deal?").
